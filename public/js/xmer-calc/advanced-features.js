...
function displayOLTC(oltc) {
    ...
    document.getElementById('advancedFeaturesContainer').insertAdjacentHTML('beforeend', oltcHTML);
}
...
function displayBIL(bil) {
    ...
    document.getElementById('advancedFeaturesContainer').insertAdjacentHTML('beforeend', bilHTML);
}
...
function displayCooling(cooling) {
    ...
    document.getElementById('advancedFeaturesContainer').insertAdjacentHTML('beforeend', coolingHTML);
}
...
function displayCostEstimation(costs, inputs) {
    ...
    document.getElementById('advancedFeaturesContainer').insertAdjacentHTML('beforeend', costHTML);
}
...
function displayLossGuarantees(check, inputs) {
    ...
    document.getElementById('advancedFeaturesContainer').insertAdjacentHTML('beforeend', html);
}
