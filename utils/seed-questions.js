...
const SEED_QUESTIONS = [
    // ── WINDING ──────────────────────────────────────────────────────────────
    { section:'winding', text:'What is the primary purpose of winding insulation in a transformer?',
      optionA:'To increase the winding resistance', optionB:'To prevent electrical breakdown between turns',
      optionC:'To reduce the core losses', optionD:'To improve cooling efficiency', correctOption:'B' },
